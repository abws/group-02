    ...
    <div class="registerform">
        ...
        <form:form modelAttribute="user" action="/register" method="post">
            ...
            <form:errors cssClass="error" path="password"/>
                ...
                <button class="button" type="button" id="password1button" onclick="toggle()"><i class="fa-solid fa-eye"></i></button>
            </div>
            <div class="label1">
            <form:errors cssClass="error" path="confirmedPassword"/>
                ...
                <button class="button" type="button" id="password2button" onclick="toggle()"><i class="fa-solid fa-eye"></i></button>
            </div>
            <div class="label1">
