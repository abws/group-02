...
public class SpicesrusApplication implements ApplicationRunner {
    ...
    private void initData() {
        ...
        r1.setFullDescription("Eggs for breakfast is a genuinely global phenomenon and there is a dazzling array of recipes from around the world using them. This one is from North Africa (versions of it are popular throughout the Middle East), "
                + "and the other main ingredient apart from egg is tomato. Various veggies can be added depending on which countrys recipe you are following, but we like it best just adding plenty of sweet peppers, whichever colour you choose."
        ...
        r5.setPicture("https://us.123rf.com/450wm/amnajtandee/amnajtandee1704/amnajtandee170400026/75769947-curry-ry?-z-sma??c?-wieprzowin?-japo?skie-jedzenie-tonkatsu-curry-rice-na-bia?ym-tle-.jpg?ver=6");
        ...
        r6.setMethod(List.of("Set a large saucepan over a medium heat and pour in the stock.", "Finely chop the coriander stalks and add to the stock with most of a sliced chilli.", "Bring to the boil and add 200ml water.",
